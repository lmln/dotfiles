...
;; with PageUp when reaching the first "screenful"
;; of text
...
;; make C-k kill whole line, not blank it
(setq kill-whole-line t)

;; limit tab function to auto-indent
(setq tab-always-indent t)

;; unsetting suspend emacs key
(global-unset-key (kbd "C-z"))
;; ... and reassigning it for undo
(global-set-key (kbd "C-z") 'undo)

;; <> to ()
(let () (keyboard-translate ?\< ?\() 
	(keyboard-translate ?\> ?\)) 
	(keyboard-translate ?\) ?\>) 
	(keyboard-translate ?\( ?\<))
